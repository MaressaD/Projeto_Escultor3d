...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pbuttonmethod = new QPushButton(centralwidget);
        pbuttonmethod->setObjectName(QString::fromUtf8("pbuttonmethod"));
        pbuttonmethod->setMaximumSize(QSize(100, 16777215));

        verticalLayout->addWidget(pbuttonmethod);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pbuttonmethod->setText(QCoreApplication::translate("MainWindow", "okay", nullptr));
